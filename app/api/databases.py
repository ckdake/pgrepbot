...
async def _add_test_databases(manager: PostgreSQLConnectionManager) -> None:
    """Add test databases to the connection manager."""
    try:
        ...
        logger.info("Added primary database to connection manager")
        ...
        logger.info("Added replica database to connection manager")
...
async def test_credential_resolution():
    ...
    try:
        ...
        try:
            primary_creds = await secrets_client.get_database_credentials("test/postgres/primary")
        ...
        # Test resolving credentials for replica database
        try:
            replica_creds = await secrets_client.get_database_credentials("test/postgres/replica")
        ...
        return {
            "primary_database": {
                "secret_name": "test/postgres/primary",
            ...
            "replica_database": {
                "secret_name": "test/postgres/replica",
